                    ...
                    <div class="card d-flex flex-column align-items-center text-center py-3">
                        ...
                        <div class="card-body">
                            <p class="card-text">زینو تریدر علاوه بر نسخه دسکتاب در گوشی های هوشمند Android و IOS به
                                راحتی و بدون نیاز به APP Store ها در قابلیت استفاده دارد.</p>
                        </div>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-sm-12 col-md-5 col-lg-5">
                        <div class="d-flex flex-column g-3">
                            <div class="list-item p-3 my-2">تحلیل کلی روند معاملاتی سهم​​​​​​​</div>
                            <div class="list-item p-3 my-2">نمایش P/E و بررسی آن نسبت به P/E گروه​​​​​​​</div>
                            <div class="list-item p-3 my-2">نمایش YTM لحظه ایی و YTM مظنه خرید و فروش اوراق بدهی​​​​​​​
                            </div>
                            <div class="list-item p-3 my-2">نمودار روند خرید و فروش حقیقی و حقوقی​​​​​​​</div>
                            <div class="list-item p-3 my-2">نمودار سهامدارن عمده شرکت​​​​​​​</div>
                            <div class="list-item p-3 my-2">یاد داشت گذاری چند گانه برروی سهم​​​​​​​</div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-5">
                        <div class="d-flex flex-column g-3">
                            <div class="list-item p-3 my-2">نمودار لحظه ای صف و عمق بازار</div>
                            <div class="list-item p-3 my-2">مدیریت همزمان پرتفوی و سفارشات در صفحه اصلی</div>
                            <div class="list-item p-3 my-2">ارسال سفارش به شکل پاپ آپ و چند تایی</div>
                            <div class="list-item p-3 my-2">نمودار رنج معاملاتی روز</div>
                            <div class="list-item p-3 my-2">حذف و ویرایش گروهی سفارشات</div>
                            <div class="list-item p-3 my-2">تحلیل کلی روند معاملاتی سهم​​​​​​​</div>
                        </div>
                    </div>
                </div>
